...
- Animation tutorial [notebook](./00ani_wave.ipynb), [markdown](./00ani_wave.ipynb/00ani_wave.md), [pdf](./00ani_wave.pdf), [html](./00ani_wave.html) 
...
- 1D spectral finite element in homogeneous medium(coming soon...)
- 1D spectral finite element in heterogeneous medium(coming soon...)