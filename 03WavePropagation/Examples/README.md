...
- The spectral element codes require downloading the utility files [gll.py](gll.py), [lagrange.py](lagrange.py), [lagrange1st.py](lagrange1sr.py), [lagrange2.py](lagrange2.py), [legendre.py](legendre.py) and [ricker.py](ricker.py) 
